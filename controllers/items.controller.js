...
class itemController {
    ...
    async createItem(req, res, next) {
        ...
        if (validName(name)) {
            ...
            res.status(400).json({ message: `Debe introducir nombre valido para el objecto` })
        }
    }
    ...
    async updateItem(req, res, next) {
        ...
        if (await checkItem(id)) {
            ...
            res.status(400).json({ message: `El item id ${id} a actualizar no existe` });
        }
    }
    ...
    async deleteItem(req, res, next) {
        ...
        if (await checkItem(id)) {
            ...
            res.status(400).json({ message: `El item id ${id} a eliminar no existe` });
        }
    }
}
