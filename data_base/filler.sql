...
insert into usuario(id,name,email,type,is_active, chief) values
('ldac', 'MAC', 'ldac@usb.ve', 4444,  true, 'ldac');

insert into usuario(id,name,email,type,is_active, chief) values
('cchang', 'Carolina Chang', 'cchang@usb.ve', 2222, true, 'ldac');

insert into usuario(id,name,email,type,is_active, chief) values
('DCI', 'Departamento de Computacion', 'dci@usb.ve', 0000, true, 'DCI');

insert into usuario(id,name,email,type,is_active, chief) values
('labF', 'Laboratorio F', 'labf@usb.ve', 3333, true, 'DCI');

/*Rellenamos la tabla de room*/

--superINSERT

insert into room(id, name,owner_id, manager_id, is_active,description , last_used, first_used, pathImage) values
('MYS-019', 'Sala A','ldac', 'cchang', true, 'La mejor sala del mundo', '2020-07-02', '2018-06-05','/media/MYS-019.jpg');
--superINSERT

insert into room(id, name,owner_id, manager_id, is_active,description , last_used, first_used) values
('MYS-001', 'Sala F','ldac', 'cchang', true, 'Sala F, el switch murio',  '2020-01-01', '2018-01-05','/media/MYS-001.jpg');

--superINSERT

insert into room(id, name,owner_id, manager_id, is_active,description , last_used, first_used) values
('MYS-014', 'Sala E','ldac', 'cchang', true, 'Sala F, el switch murio',  '2020-01-01', '2018-01-05','/media/MYS-014.jpg');
